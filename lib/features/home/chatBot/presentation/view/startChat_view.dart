              ...
              child: Center(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    ...
                    Text("How Can I Assist You",style: AppTextStyles.font24W800White(fontSize: 18)),
                    Text("Today ?",style: AppTextStyles.font24W800White(fontSize: 18)),

                    Padding(
                      padding:  EdgeInsets.symmetric(horizontal:30.w,vertical: 20.h),
                      child: CustomButton(text: "Get Started", onPressed: ()=>    Navigator.pushReplacementNamed(context, AppRoutes.ChatScreen),),
                    )
                  ],
                ),
              ),
