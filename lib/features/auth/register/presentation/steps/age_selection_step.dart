...
class AgeSelectionStep extends StatelessWidget {
  final RegisterCubit cubit;

  const AgeSelectionStep({super.key, required this.cubit});
  ...
  Widget build(BuildContext context) {
    return StepWithBackButton(
      ...
      child: _buildNumberSelector(
        ...
        50,
        'age',
        StringsManager.howOldAreYou,
        StringsManager.agePersonalizedPlan,
      ),
    );
  }
