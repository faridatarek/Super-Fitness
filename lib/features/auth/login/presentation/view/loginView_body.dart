         ...
         Padding(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
              Text(StringsManager.heyThere,style: AppTextStyles.font18W400White(),),
              Text(StringsManager.welcomeBack,style: AppTextStyles.font20W800White(),)
            ],),
          ),
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                CustomTextField(
                                  ...
                                  validator: loginValidator.validate(LoginValidatorTypesEnum.email),
                                  prefixIcon: Icon(
                                ...
                                CustomTextField(
                                  ...
                                  validator: loginValidator.validate(LoginValidatorTypesEnum.password),
                                  prefixIcon: Icon(
                                    Icons.lock_outline,
                                    color: ColorManager.white,
                                  ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: AppTextStyles.font18W400White(fontSize: 14.sp),
                                    ),
                                    InkWell(
                                      onTap: () {},
                                      child: Text(
                                        StringsManager.register,
                                        style: AppTextStyles.font14W800White(color: ColorManager.primary),
                                      ),
                                    ),
                                  ],
                                ),
